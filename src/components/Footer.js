    ...
    <>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-[1px]'>
        ...
        <div className='bg-gray-900 p-4 text-gray-300'>
          ...
          <h1 className="mb-4"><NavLink to="/policy" className="text-gray-300 hover:text-white">Privacy Policy</NavLink></h1>
          ...
          <div>
            <p className="text-gray-300 mb-3">&copy; {new Date().getFullYear()} NAT-Services, An Online Worker Finder Portal. All Rights Reserved. Developed by <b>NATIONAL</b>.</p>
          </div>
        </div>
      </div>
    </>
